...
fast_downward_plugin(
    ...
    DEPENDS CAUSAL_GRAPH INT_PACKER ORDERED_SET SUCCESSOR_GENERATOR TASK_PROPERTIES BLIND_SEARCH_HEURISTIC PDBS MAS_HEURISTIC PLUGIN_EXTERNAL_LAZY_ASTAR PLUGIN_EXTERNAL_ASTAR
    DEPENDENCY_ONLY
)

# START OF EXTERNAL SEARCH PLUGINS
fast_downward_plugin(
    NAME PLUGIN_EXTERNAL_LAZY_ASTAR
    HELP "SSD-based A* search (lazy)"
    SOURCES
        external/search_engines/plugin_lazy_astar
