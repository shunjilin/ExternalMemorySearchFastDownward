#ifndef EXTERNAL_SEARCH_ENGINES_ASTAR_DDD_SEARCH_H
#define EXTERNAL_SEARCH_ENGINES_ASTAR_DDD_SEARCH_H
...
namespace astar_ddd_search {
    class AStarDDDSearch : public SearchEngine {
    ...
    public:
        explicit AStarDDDSearch(const options::Options &opts);
        virtual ~AStarDDDSearch() = default;
